...
6. Rename the downloaded file using the format department_pridefloat
   (e.g. creative services_pridefloat) so Creative Services can quickly
   attribute submissions without relying on text in the image.
7. Upload the renamed image to the Pride at Zoro Google Drive folder:
